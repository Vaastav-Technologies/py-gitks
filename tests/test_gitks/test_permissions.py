...
from gitks.core.gpg import detached_sign, fingerprint_of
...
def _ks(repo_local, tmp_path):
    return ks_for_test(repo_local, tmp_path)


def _export_and_sign(gpg, key):
    return export_and_sign(gpg, key)
